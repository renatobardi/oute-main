...
export const sidebarCollapsed = createCollapsedStore('projectsSidebarCollapsed');
export const notePanelCollapsed = createCollapsedStore('projectsNotePanelCollapsed');
